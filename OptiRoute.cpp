...
int main() {
    ...
    ifstream infile("OptiRoute-Data.txt");
    if (!infile) {
    ...
    cout << "\t\t\t\t\t WELCOME TO OptiRoute\n";
    cout << "\t\t__________________________________________________________________\n\n";
    cout << "\t\tOptiRoute is a travel planning and route recommendation platform\n \t\tthat helps users discover and plan trips to various destinations\n \t\t\t\t\t across India.";
    cout<<endl;
    cout<<endl;
    cout<<endl;
